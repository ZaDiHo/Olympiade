...
public class Cuboid {
    ...
    public static void fillStartRace() {
        Cuboid startRace = new Cuboid(new Location(Bukkit.getWorld("OlympiadeS3_nether"), -884.5, 91, 60.5), new Location(Bukkit.getWorld("OlympiadeS3_nether"), -884.5, 92, 53.5));
        for (Iterator<Block> it = startRace.blockList(); it.hasNext(); ) {
            Block blocks = it.next();
            blocks.setType(Material.BARRIER);
        }
    }

    public static void clearStartRace() {
        Cuboid startRace = new Cuboid(new Location(Bukkit.getWorld("OlympiadeS3_nether"), -884.5, 91, 60.5), new Location(Bukkit.getWorld("OlympiadeS3_nether"), -884.5, 92, 53.5));
        for (Iterator<Block> it = startRace.blockList(); it.hasNext(); ) {
            Block blocks = it.next();
    ...
    public static void fillStartJump() {
        Cuboid startJump = new Cuboid(new Location(Bukkit.getWorld("OlympiadeS3_nether"), -1144.5, 67, 43.5), new Location(Bukkit.getWorld("OlympiadeS3_nether"), -1144.5, 70, 39.5));
        for (Iterator<Block> it = startJump.blockList(); it.hasNext(); ) {
            Block blocks = it.next();
            blocks.setType(Material.BARRIER);
        }
    }

    public static void clearStartJump() {
        Cuboid startJump = new Cuboid(new Location(Bukkit.getWorld("OlympiadeS3_nether"), -1144.5, 67, 43.5), new Location(Bukkit.getWorld("OlympiadeS3_nether"), -1144.5, 70, 39.5));
        for (Iterator<Block> it = startJump.blockList(); it.hasNext(); ) {
            Block blocks = it.next();
            blocks.setType(Material.AIR);
